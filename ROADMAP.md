...
>
> **Versão:** 13 (Sprint 1.8 Fase B entregue — fecha o item 10 do `crm-api/ROADMAP.md` §6.4 / Fase 1 backend concluída)
...
>
> **Cross-repo (17/05/2026):** **Fase 1 backend concluída** no `crm-api` (Sprint 1.9 deploy + Sprint 1.9-hotfix). Frontend: Sprint 1.6 Fase B e **Sprint 1.8 Fase B entregues** (esta última nesta branch). O checklist ponta-a-ponta `crm-api/ROADMAP.md` §6.4 está verde nos itens 1–11 — o **item 10 ("status do canal em tempo real no frontend") está fechado**: a emissão backend (Socket.IO `channel:status`, Sprint 1.8b) e a superfície de UI (card consome o socket, badge realtime, toasts críticos, `lastError`, indicador de reconexão) estão entregues. Resta a validação manual ponta-a-ponta contra `crm-api` local antes de declarar a fatia frontend da Fase 1 concluída.
>
...
- [x] Pareada com Sprint 1.8 do `crm-api` (eventos Socket.IO `channel:status`)
- [x] Card de canal em `/configuracoes/canais` consome socket.io-client
- [x] Indicador visual por estado (badge já existe da 1.4b; falta o realtime feed)
- [x] Toast em transições críticas (`CONNECTED → DISCONNECTED`, qualquer estado → `ERROR`)
- [x] Mostra `lastError` quando estado é `ERROR`
- [x] Reconexão automática do socket (com indicador de "reconectando")
...
| Fase 1  | 2026-05-11 | —          | em andamento | **Fase 1 backend concluída no `crm-api`** (Sprint 1.9 deploy Coolify + 1.9-hotfix externalId; `crm-api/ROADMAP.md` v23). Frontend: Sprints 1.4 Fase B (canais UI) e 1.4 Fase C (motivos de fechamento) em PR #35; Sprint 1.6 Fase B (mensagens debug) em PR #40; **Sprint 1.8 Fase B (realtime do canal) entregue — fecha o §6.4 item 10 do `crm-api`**. Resta validação manual ponta-a-ponta contra `crm-api` local antes de declarar a fatia frontend concluída. |
| Fase 2  | —          | —          | aguardando   | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Fase 3a | —          | —          | aguardando   | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Fase 3b | —          | —          | aguardando   | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Fase 4  | —          | —          | aguardando   | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
