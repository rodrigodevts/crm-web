...
>(({ className, showIcon = false, ...props }, ref) => {
  // Deterministic pseudo-random width entre 50% e 90% — derivado do useId
  // pra manter aparência variada sem usar Math.random (que React 19 sinaliza
  // como impuro em render).
